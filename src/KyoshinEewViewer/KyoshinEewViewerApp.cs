...
public static class KyoshinEewViewerApp
{
	...
	public static IServiceCollection AddKyoshinEewViewer(this IServiceCollection services)
	{
		...
		services.AddSingleton<NetworkDebugRecorder>();
		...
		services.AddSingleton<JmaXmlSettingPage>();
		services.AddSingleton<EqMonitorSettingPage>();
		...
		services.AddSingleton<Series.EewHistory.EewHistorySeries>();
