...
public partial class KyoshinEewViewerConfiguration : ObservableObject, IWindowPlacementConfig
{
	...
	public partial class KyoshinMonitorConfig : ObservableObject
	{
		...
		[ObservableProperty]
		public partial bool UseExperimentalShakeDetect { get; set; }
	...
	[ObservableProperty]
	public partial JmaXmlConfig JmaXml { get; set; } = new();
	public partial class JmaXmlConfig : ObservableObject
	{
		/// <summary>
	...
	[ObservableProperty]
	public partial EqMonitorConfig EqMonitor { get; set; } = new();
	public partial class EqMonitorConfig : ObservableObject
	{
		/// <summary>
		...
		/// </summary>
		[ObservableProperty]
		public partial bool EnableEarthquake { get; set; } = true;
		...
		/// </summary>
		[ObservableProperty]
		public partial int EarthquakeFetchCount { get; set; } = 50;
	}
	...
	public partial class DebugConfig : ObservableObject
	{
		...
		/// </summary>
		[ObservableProperty]
		public partial bool ShowPerformanceHud { get; set; }
		...
		/// </summary>
		[ObservableProperty]
		public partial bool RecordNetworkTraffic { get; set; }
	}
}
